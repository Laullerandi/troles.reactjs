    ...
    return (
        <>
            <Box bg='#ffffff' minHeight='100vh'>
                <Box mt='170'>
                    <Center><Text fontSize="2xl" mb='10'>Carrito</Text></Center>
                    <Flex justifyContent="space-between">
                        ...
                        <Box flex="0 0 auto" mr='40'>
                            ...
                            <Center>
                                <Link to={'/form'}>
                                    <button type="submit" className="submit-button-cart">Verificar</button>
                                </Link>
                            </Center>
                        </Box>
                    </Flex>
                        ...
                        >
                            <AlertDialogOverlay>
                                <AlertDialogContent>
                                    ...
                                    <AlertDialogBody>
                                        Estás segurx que quieres vaciar el carrito? Esta acción no se puede deshacer.
                                    </AlertDialogBody>
                                    <AlertDialogFooter>
