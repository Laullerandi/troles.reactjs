...
const Form = () => {
    ...
    const handleSubmit = (e) => {
        ...
        if (name === "" || surname === "" || email === "" || cardNumber === "" || date === "" || cvv === "" || address === "" || number === "") {
            alert("Por favor completar todos los items.")
        } else {
    ...
    return (
        <Center minH="100vh">
            <Box width="400px" mt='120'>
                <Center><Text fontStyle='oblique' textDecoration='underline' mb='10'>Llene el formulario para completar la orden.</Text></Center>
                <form onSubmit={handleSubmit}>
                    ...
                    <Center><button type="submit" className="submit-button">Enviar</button></Center>
                </form>
                {showAlert && ( 
                    <Alert
                        status='success'
                    ...
                    >
                        ...
                        <AlertDescription maxWidth='sm'>
                            Gracias por comprar en Troles Indumentaria. El Id de tu orden es: {orderId}.
                        </AlertDescription>
                    </Alert>
                )}
            </Box>
